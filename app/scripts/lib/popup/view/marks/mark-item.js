...
const MarkItem = React.createClass({
  ...
  render() {
    ...
    return (
      <div className={`mark-item mark-item-${severityClass} clearfix`} onClick={this.handleMarkClick}>
        <div className="mark-item-text">
          <i className={`mark-item-severity icon-${severityClass}`}></i>
          {mark.correctable ? <i className="mark-item-correctable fa fa-check" title={translate("correctable")}></i> : ""}
          <span className="mark-item-message">{mark.message}</span>
        </div>
        <div className="mark-item-menu">
          <a href={ruleHomepage || "#"} className="mark-item-menu-item" title={mark.ruleId} target="_blank">
...
const UndismissButton = React.createClass({
  render() {
    return (
...
const DismissButton = React.createClass({
  render() {
    return (
      <div className="btn-group mark-dismiss">
        ...
        <ul className="dropdown-menu dropdown-menu-right">
          <li>
            <a href="#" className="mark-dismiss-this" onClick={this.props.onDismissThisClick}>
              {translate("dismissOnlyThis")}
            </a>
          </li>
          <li>
            <a href="#" className="mark-dismiss-same" onClick={this.props.onDismissSameClick}>
